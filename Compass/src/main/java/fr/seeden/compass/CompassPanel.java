...
public class CompassPanel extends AppPanel {
    ...
    public CompassHandler compassHandler = new CompassHandler(this);
    private final CompassKeybinds keybindings = new CompassKeybinds();

    public CompassPanel(CompassApp compassApp, CompassWindow window) {
        super(compassApp, window);
